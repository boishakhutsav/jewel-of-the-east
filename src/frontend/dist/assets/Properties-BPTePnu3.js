import { t as o, r as reactExports, v as vt, k as useProperties, w as useUpdateProperty, x as useAddProperty, m as useBackendActor, j as jsxRuntimeExports, M as MapPin, X } from "./index-DmFk9ZaG.js";
import { B as Badge } from "./badge-VlEU37wP.js";
...
import { S as SquarePen } from "./square-pen-CYs_pcKY.js";
...
function PropertyEditor({
  ...
  const [name, setName] = reactExports.useState(property.name);
  const [description, setDescription] = reactExports.useState(property.description);
  const [bookingUrl, setBookingUrl] = reactExports.useState(property.bookingUrl ?? "");
  const [amenities, setAmenities] = reactExports.useState(property.amenities.join(", "));
  const [highlights, setHighlights] = reactExports.useState(property.highlights.join(", "));
  const handleSave = () => {
    onSave({
      ...property,
      name,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-6 space-y-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: `prop-name-${property.id}`, children: "Property Name" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: `prop-desc-${property.id}`, children: "Description (HTML supported)" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Textarea,
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: `prop-booking-${property.id}`, children: "Booking URL" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Input,
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: `prop-amenities-${property.id}`, children: "Amenities (comma-separated)" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Input,
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: `prop-highlights-${property.id}`, children: "Highlights (comma-separated)" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Input,
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 justify-end", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { onClick: handleSave, "data-ocid": "admin.property.save_button", children: [
...
function PropertyAddDialog({
  ...
  const [bookingUrl, setBookingUrl] = reactExports.useState("");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "add-prop-name", children: "Property Name" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Input,
        {
          id: "add-prop-name",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "add-prop-location", children: "Location" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Input,
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "add-prop-desc", children: "Description (HTML supported)" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Textarea,
        {
          id: "add-prop-desc",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "add-prop-booking", children: "Booking URL" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Input,
        {
          id: "add-prop-booking",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "add-prop-amenities", children: "Amenities (comma-separated)" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Input,
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "add-prop-highlights", children: "Highlights (comma-separated)" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Input,
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "add-prop-image", children: "Hero Image" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Input,
        {
          id: "add-prop-image",
...
function PropertiesManager() {
  ...
  const handleAdd = async (propertyInput) => {
    setAddError(null);
    try {
      if (!actor) {
        throw new Error(
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl font-bold text-foreground", children: "Properties" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: "Edit property descriptions, amenities, and booking links" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Dialog, { open: dialogOpen, onOpenChange: setDialogOpen, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { "data-ocid": "admin.property.add_button", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "max-w-lg max-h-[90vh] overflow-y-auto", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(PropertyAddDialog, { onSave: handleAdd }),
          addError && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 p-3 rounded-md bg-destructive/10 text-destructive text-sm", children: addError })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-6", children: properties.map((property, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
      {
        initial: { opacity: 0, y: 10 },
        animate: { opacity: 1, y: 0 },
        transition: { delay: i * 0.05 },
        children: editingId === property.id ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          PropertyEditor,
          {
            property,
            onSave: handleSave,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between mb-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
              property.heroImage ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                "img",
                {
              ...
              ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 rounded-lg bg-muted flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "size-6 text-muted-foreground/40" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-xl font-bold text-foreground", children: property.name }),
                property.bookingUrl && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "a",
                  {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Button,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SquarePen, { className: "size-4 mr-2" }),
                  "Edit"
                ]
              }
            )
          ...
          property.highlights.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-foreground mb-2", children: "Highlights" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: property.highlights.map((h) => /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", children: h }, `highlight-${h}`)) })
          ] }),
          property.amenities.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-foreground mb-2", children: "Amenities" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: property.amenities.map((a) => /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", children: a }, `amenity-${a}`)) })
          ] })
        ] }) })
      },
