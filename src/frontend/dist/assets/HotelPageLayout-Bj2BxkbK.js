import { j as jsxRuntimeExports, M as MapPin, P as Phone, r as reactExports } from "./index-DmFk9ZaG.js";
...
import { C as ChevronUp, a as ChevronDown } from "./chevron-up-CLW7tR2q.js";
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "overflow-hidden group hover:shadow-2xl transition-all duration-500 h-full flex flex-col bg-[#FDFBF7] border-0 rounded-2xl", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-6 flex-1 flex flex-col", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mt-auto pt-4 border-t border-[#0B2B1B]/10", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-[#0B2B1B]/50 uppercase tracking-wider", children: "per night" }) }),
              bookingUrl && /* @__PURE__ */ jsxRuntimeExports.jsx(
                "a",
                {
                  href: bookingUrl,
                  target: "_blank",
...
function GallerySection({ gallery }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-16 bg-[#FDFBF7]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4", children: gallery.map((img, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
      {
...
function HotelPageLayout({ hotel }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    hotel.gallery.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(GallerySection, { gallery: hotel.gallery }),
