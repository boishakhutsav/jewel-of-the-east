...
export default function ContactPage() {
  ...
  const _contact = settings?.contactInfo;
    ...
    <div>
      <section className="py-16 bg-[#0B2B1B]">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-[#FDFBF7]/70 max-w-2xl mx-auto">
            We would love to hear from you. Reach out directly for bookings,
      ...
      <section className="py-16 bg-[#0B2B1B]">
        <div className="container mx-auto px-4">
          ...
          <p className="text-[#FDFBF7]/70 text-center max-w-2xl mx-auto mb-12">
            We would like to hear from you. Visit our properties in the heart of
            the Himalayas.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h3 className="font-display text-xl font-semibold text-[#FDFBF7] mb-4 text-center">
                Jewel Himalayan Heights
              </h3>
              <div className="rounded-lg overflow-hidden shadow-lg border border-[#c9a96e]/20">
                <iframe
